...
public class Persona {
	 ...
	 * @param dNI El DNI con el que se identificar� a la persona.
	 */
	...
	/**
	 * Muestra por consola el estado actual de la cuenta pasada por par�metro.
	 * @param numCuenta El n�mero de cuenta de la que queremos informaci�n.
	 */
	...
	public void recibirDinero(float cantidad, int numCuenta){
		if(numCuenta < this.numCuentasMax)
			...
			System.out.println("La cuenta n�mero: " + numCuenta + " no existe.");
	}
