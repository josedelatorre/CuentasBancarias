...
public class Persona {
	 ...
	 * 
	 * @param dNI
	 *            El DNI con el que se identificará a la persona.
	 */
	 ...
	 * 
	 * @param numCuenta
	 *            El número de cuenta de la que queremos información.
	 */
	public void imprimirEstadoCuenta(int numCuenta) {
		if (cuentas.get(numCuenta) != null)
			System.out.println("Cuenta " + cuentas.get(numCuenta).getNumeroCuenta() + " saldo: "
					+ cuentas.get(numCuenta).getSaldo());
	}
	...
	/**
	 * Realiza un traspaso de dinero entre la primera cuenta especificada y la
	 * segunda.
	 * 
	 * @param numCuenta1
	 *            la cuenta de la que se quiere extraer el dinero.
	 * @param numCuenta2
	 *            la cuenta en la que se quiere recibir el dinero.
	 * @param cantidad
	 *            la cantidad de dinero que se quiere traspasar.
	 */
